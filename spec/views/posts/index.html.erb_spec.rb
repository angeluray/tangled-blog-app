...
RSpec.describe 'Post Index', type: :feature do
  before(:each) do
    ...
    Comment.create(post_id: @post1.id, author_id: @user1.id, text: 'Hi everytone, nice to meet you!')
    Comment.create(post_id: @post1.id, author_id: @user1.id, text: 'Hello loves, welcome!!')
    Comment.create(post_id: @post2.id, author_id: @user1.id, text: 'How are you?, been a while')

    Like.create(post_id: @post1.id, author_id: @user1.id)
